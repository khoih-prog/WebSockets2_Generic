 ...
 *****************************************************************************************************************************/
/****************************************************************************************************************************
  STM32-Minimal-Client: Minimal STM32 Websockets Client
  ...
  This sketch:
    ...
    to try the example named "STM32-Client".
...
void setup() 
{
  ...
  Serial.println("\nStarting WebSockets2_Generic STM32-Minimal-Client with WiFiNINA on " + String(BOARD_NAME));
