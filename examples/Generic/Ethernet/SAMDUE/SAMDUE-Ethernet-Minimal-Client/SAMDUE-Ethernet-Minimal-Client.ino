/****************************************************************************************************************************
  SAMDUE-Ethernet-Minimal-Client.ino
 ...
 *****************************************************************************************************************************/
/****************************************************************************************************************************
  SAMDUE-Ethernet-Minimal-Client: Minimal SAM DUE Websockets Client
  ...
  This sketch:
    ...
    to try the example named "SAMDUE-Client".
...
void setup() 
{
  ...
  Serial.println("\nStarting WebSockets2_Generic SAMDUE-Ethernet-Minimal-Client on " + String(BOARD_NAME));
