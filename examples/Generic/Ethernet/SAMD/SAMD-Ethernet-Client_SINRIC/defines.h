/****************************************************************************************************************************
  defines.h for SAMD-Ethernet-Client_SINRIC.ino
  For SAMD21/SAMD51 with WiFiNINA module/shield, using SINRIC (https://sinric.com/)
...
uint8_t mac[6] =  { 0xDE, 0xAD, 0xBE, 0xEF, 0xAD, 0x02 };
