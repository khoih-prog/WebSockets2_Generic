/****************************************************************************************************************************
  SAMD-Ethernet-Client_SINRIC.ino
  For SAMD21/SAMD51 with Ethernet module/shield, using SINRIC (https://sinric.com/)
...
void setup()
{
  ...
  Serial.println("\nStarting SAMD-Ethernet-Client_SINRIC on " + String(BOARD_NAME));
