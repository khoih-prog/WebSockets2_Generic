/****************************************************************************************************************************
  SAMD-Ethernet_AdvancedWebServer.ino  
  For SAMD with Ethernet module/shield.
...
void setup()
{
  ...
  Serial.println("\nStarting WebSockets2_Generic SAMD-Ethernet_AdvancedWebServer on " + String(BOARD_NAME));
