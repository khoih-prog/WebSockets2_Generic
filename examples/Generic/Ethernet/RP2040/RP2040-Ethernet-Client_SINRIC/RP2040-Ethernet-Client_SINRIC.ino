/****************************************************************************************************************************
  RP2040-Ethernet-Client_SINRIC.ino
  For RP2040 with Ethernet module/shield, using SINRIC (https://sinric.com/)
 ...
 *****************************************************************************************************************************/
/****************************************************************************************************************************
  RP2040 Websockets SINRIC Client
  ...
  Hardware:
        For this sketch you only need a RP2040 board.
...
void setup()
{
  ...
  Serial.println("\nStarting RP2040-Ethernet-Client_SINRIC on " + String(BOARD_NAME));
