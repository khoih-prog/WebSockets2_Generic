/****************************************************************************************************************************
  RP2040-Ethernet-Minimal-Client.ino
  For RP2040 with Ethernet module/shield.
  
  Based on and modified from Gil Maimon's ArduinoWebsockets library https://github.com/gilmaimon/ArduinoWebsockets
  to support STM32F/L/H/G/WB/MP1, nRF52 . RP2040and SAMD21/SAMD51 boards besides ESP8266 and ESP32
 ...
 *****************************************************************************************************************************/
/****************************************************************************************************************************
  nRF52-Minimal-Client: Minimal nRF52 Websockets Client
...
void setup() 
{
  ...
  Serial.println("\nStarting WebSockets2_Generic RP2040-Ethernet-Minimal-Client on " + String(BOARD_NAME));
