/****************************************************************************************************************************
  Teensy-Ethernet-Minimal-Client.ino
 ...
 *****************************************************************************************************************************/
/****************************************************************************************************************************
  Teensy-Minimal-Client: Minimal Teensy Websockets Client
...
void setup() 
{
  ...
  Serial.println("\nStarting Teensy-Ethernet-Minimal-Client on " + String(BOARD_NAME));
