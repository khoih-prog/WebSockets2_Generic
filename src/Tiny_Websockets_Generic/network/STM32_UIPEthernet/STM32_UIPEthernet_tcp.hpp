/****************************************************************************************************************************
  STM32_UIPEthernet_tcp.hpp
  For STM32F/L/H/G/WB/MP1 boards with UIPEthernet ENC28J60 module/shield.
...
// KH, from v1.0.2
#if USE_UIP_ETHERNET
  #warning Using UIPEthernet Lib in STM32_UIPEthernet_tcp.hpp
  #include <UIPEthernet.h>
  #include <utility/logging.h> 
#else
  // Default to UIPEthernet library
  #warning default UIPEthernet Lib in STM32_UIPEthernet_tcp.hpp
  #include <UIPEthernet.h>
  #include <utility/logging.h> 
#endif
//////
